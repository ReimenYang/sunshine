module.exports = {
  ...
  // plugins: [
  //     // 'prettier' // 插件，此插件用于识别文件中的js代码，没有MIME类型标识没有script标签也可以识别到，因此拿来识别.vue文件中的js代码
  // ],
  rules: {
    /**
     * 代码中可能的错误或逻辑错误
    ...
    //  * eslint-plugn-vue
    //  */
    "vue/attribute-hyphenation": ["error", 'never', { "ignore": ['scale-min', 'scale-max'] }]//遇到大写字母，强制用-符号链接！vue可以启用，但uniapp组件属性无法支持kebab-case,只能用驼峰，因此一定要禁用此规则
  }
};