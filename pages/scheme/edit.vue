...
<script>
import mixinPhase from '@/pages/scheme/mixinPhase.js'
import baseInfo from '@/pages/scheme/_baseInfo'
import channel from '@/pages/scheme/_channelConfig'
import postionList from '@/pages/scheme/_postionList'
import phaseSetting from '@/pages/scheme/_phaseSetting'
export default {
  mixins: [mixinPhase],
